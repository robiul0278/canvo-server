...
__decorate([
    ...
    __param(0, (0, common_1.Query)(new zod_validation_pipe_1.ZodValidationPipe(query_user_dto_1.QueryUserDto))),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('admin'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Activate/Deactivate user (Admin only)' }),
    __param(0, (0, common_1.Param)('id')),
